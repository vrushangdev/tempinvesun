        ...
        <ul class="nav align-items-center">
            <li class="nav-item dropdown ">
                ...
                <div class="dropdown-menu  dropdown-menu-right">
                    ...
                    <input type="hidden" class="copyLinkUrl" id="copyTarget" value="http://invesun.homipod.com?shared=techpartner&sharing_id={{ Auth::guard('tech_partner')->user()->sharing_id }}">

    ...
    <div class="container ">
        <div class="row m-h-100 ">
            <div class="col-md-12 col-lg-12 m-auto">
            	<div class="avatar">
                    <a href="{{ route('formTwo',[$id,$proposal_id]) }}" class="previous">
    			        <div class="avatar avatar-title bg-success rounded-circle slider-btn-left-preview">
			    ...
			    <div class="avatar right">
			    	<a href="javascript:void(0);" class="next submit">
				        <div class="avatar avatar-title bg-success rounded-circle slider-btn-right-preview">
                        ...
                        <div class="">
                           	<form id="login" name="login" action="{{ route('saveFormThree') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="emi_start" name="emi_start" placeholder="EMI Starts At" value="{{ $emiStart }}" readonly required>
                                </div>

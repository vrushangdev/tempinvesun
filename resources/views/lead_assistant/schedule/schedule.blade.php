                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            @foreach($getWeekDates as $mk => $date)
                                                <td><input type="checkbox" name="data[1][date][{{ $mk }}][date]" value="{{ $date['date'] }}" @if(in_array($date['date'],$morningDate)) checked @endif></td>
                                            @endforeach
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            @foreach($getWeekDates as $ak => $date)
                                                <td><input type="checkbox" name="data[2][date][{{ $ak }}][date]" value="{{ $date['date'] }}" @if(in_array($date['date'],$noonDate)) checked @endif></td>
                                            @endforeach
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            @foreach($getWeekDates as $ek => $date)
                                                <td><input type="checkbox" name="data[3][date][{{ $ek }}][date]" value="{{ $date['date'] }}" @if(in_array($date['date'],$eveningDate)) checked @endif></td>
                                            @endforeach
                                        </tr>
                                    </tbody>
                                </table>

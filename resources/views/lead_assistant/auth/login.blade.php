...
@section('title','Lead Assistant Login | Invesun')
@section('content')
            ...
            <div class="col-lg-4  bg-white">
                <div class="row align-items-center m-h-100">
                    <div class="mx-auto col-md-8">
                        ...
                        <form class="needs-validation" method="POST" action="{{ route('lead_assistant.postlogin') }}" id="loginForm">
                            @csrf   
                            <div class="form-row">
                        ...
                        <p class="text-right p-t-10">
                            <a href="{{ route('lead_assistant.auth.password.reset') }}" class="text-underline">Forgot Password?</a>
                        </p>
                    </div>
                </div>
            </div>
